$('document').ready(function(){
  ...
  $(".HomeText").click(function() {
	...
	$(".LeftTitle").click(function() {
		location.reload();
		 $('.grid').removeClass('scale');
		 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
		 $('.WorkReal').removeClass('IMGscale');
	...
	$(".IMGcarousel1").click(
		 function() {
			 ...
			 $('.STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
	...
	$(".IMGcarousel2").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel3").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel4").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel5").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel6").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .FACEREC_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel7").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .GESTURAL_DESC, .FACEREC_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel8").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .FACEREC_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
	...
	$(".IMGcarousel9").click(
		 function() {
			 ...
			 $('.VANGUARD_DESC, .STRESSSUCKS_DESC, .POLARIS_DESC, .SOLLEWITT_DESC, .ITRAINED_DESC, .BADASSBAUHAUS_DESC, .GESTURAL_DESC, .WHATHAPPENED_DESC').removeClass('CenterText');
			 $('#carousel_image img').addClass('carouselscale');
			 $('div[class^="module"]').addClass('IMGscale');
